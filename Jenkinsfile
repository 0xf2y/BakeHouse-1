            ...
            steps {
                script {
                    ...
                    if (params.ENV_ITI == "release") {
                        withCredentials([usernamePassword(credentialsId: '7c3d240b-00a6-4ec2-a392-7ee15ccd4ce3', usernameVariable: 'USERNAME_SYSADMIN', passwordVariable: 'PASSWORD_SYSADMIN')]) {
                            sh '''
            ...
            steps {
                ...
                script {
                    if (params.ENV_ITI == "dev" || params.ENV_ITI == "test" || params.ENV_ITI == "prod") {
                        withCredentials([file(credentialsId: '3f6ac111-d29d-4121-8163-4d5c49a72be0', variable: 'KUBECONFIG_ITI')]) {
                            sh '''
